...
# binom.test # ===== #
binom.test(8,20,0.25,alternative = "greater") #1 cola y cola der
binom.test(8,20,0.25,alternative = "less") #1 cola y cola izq
binom.test(8,20,0.25,alternative = "two.sided") #2 colas
